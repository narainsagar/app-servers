...
<body id="sample">
  <div class="textColumn">
    ...
    <p>Your first CICD AWS Elastic Beanstalk Python Application is now running on your own dedicated environment in the AWS Cloud</p>
    <p>You have successfully deployed V2</p>
  </div>
